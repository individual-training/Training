...
export default class EditUser extends React.Component {
  ...
  reset = () => {
    const { editUser:{dataStringify}, dispatch } = this.props;
    dispatch({
      type:'editUser/setEditUser',
      ...
      >
        ...
        >
          ...
          <div className={styles.bottomBtns} style={{margin:40}}>
            ...
            <Button className={`${styles.formBtn} ${styles.greenBtn}`} onClick={this.submit} loading={btnLoading}>提交</Button>
          </div>
        </Form>
      </Modal>
    );
