        ...
        <Layout className={styles.indexLayout}>
          ...
          <Content className={styles.content}>
            <Row className={styles.row}>
              <Col span={12}>
                <IndexCard mess={'人员录入'} position={'right'} to={'/users'} image={'renYuanIndex.png'}></IndexCard>
              </Col>
              <Col span={12} >
                <IndexCard mess={'数据查询'} to={'/search'} image={'shuJuIndex.png'} ></IndexCard>
              </Col>
            </Row>
            <Row className={styles.row}>
              <Col span={12}>
                <IndexCard mess={'单位数据'} position={'right'} to={'/department'} image={'danWeiIndex.png'} ></IndexCard>
              </Col>
              <Col span={12}>
                <IndexCard mess={'设置'} image={'sheZheIndex.png'} extra={
